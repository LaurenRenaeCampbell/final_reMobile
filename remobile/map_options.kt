...
class map_options : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_map_options)

        val map_op_back = findViewById<ImageButton>(R.id.map_op_backbutton)
        map_op_back.setOnClickListener{
            val intent = Intent(this,mappage::class.java)
            startActivity(intent)
        }

        val map_op2_back = findViewById<Button>(R.id.map_op_exp)
